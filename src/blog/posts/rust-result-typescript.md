...
When I first started learning programming, I started where many do: the weak, dynamic typing of Javascript. For a long time, I didn't understand why I'd ever want to use a strong, statically typed language&mdash;until Rust broke my brain. There's a ton of things about Rust that really changed how I understand programming (the borrow checker, lifetimes, multiple string types, etc.), but the part I find myself missing no matter what other language I'm using is the type system.
